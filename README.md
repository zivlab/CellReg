...
We encourage the use of official versions (e.g., v1.5.1) for easier debugging processes. Switch to the releases tab on GitHub and checkout the latest version.
