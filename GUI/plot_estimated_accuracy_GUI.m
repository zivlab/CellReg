function plot_estimated_accuracy_GUI(handles,p_val_vec,p_thresh,p_value_dist,normalized_distance,num_pairs_dist,true_merge_dist,false_merge_dist,centers_of_bins,maximal_distance,microns_per_pixel,imaging_technique,varargin)
