...
aligned_spatial_footprints = get_spatial_footprints(spatial_footprints{1});
ncells = aligned_spatial_footprints.size(1);

    
number_of_bins=10*round((minimal_number_of_bins+ncells/...
    number_of_cells_factor*(number_of_sessions)^2)/10);
