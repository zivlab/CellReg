function [adjusted_spatial_footprints,adjusted_FOV_all_sessions,adjusted_x_size,adjusted_y_size]=adjust_FOV_size(spatial_footprints)
...
for n=1:number_of_sessions   
    ...
    new_spatial_footprints=zeros(number_of_cells,adjusted_y_size,adjusted_x_size);
    for k=1:number_of_cells
        spatial_footprint_temp=squeeze(spatial_footprints_temp(k,:,:));
        new_temp_spatial_footprint=zeros(adjusted_y_size,adjusted_x_size);
        new_temp_spatial_footprint(1:size(spatial_footprint_temp,1),1:size(spatial_footprint_temp,2))=spatial_footprint_temp;
        new_spatial_footprints(k,:,:)=new_temp_spatial_footprint;
    end
    adjusted_spatial_footprints{n}=new_spatial_footprints;
end
